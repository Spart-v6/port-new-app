  ...
  return (
    <>
      ...
      <div className="hero-contact">
        ...
        <div className="contact-form">
          ...
          <div className="leftDetails">
            ...
            <svg viewBox="0 0 383 264" fill="none" >
                ...
                <path d="M224 254C224 234.433 227.854 215.058 235.342 196.98C242.83 178.903 253.805 162.477 267.641 148.641C281.477 134.805 297.903 123.83 315.98 116.342C334.058 108.854 353.433 105 373 105V254H224Z" fill="#F90077" id="circ2"/>
        ...
        <div id="rightBigCirc">
          <svg width="350" height="350" viewBox="0 0 350 350" fill="none">
            <path d="M0 350C0 304.037 9.05305 258.526 26.6423 216.06C44.2316 173.598 70.0117 135.013 102.512 102.512C135.013 70.0117 173.598 44.2316 216.06 26.6423C258.526 9.05305 304.037 0 350 0V350H0Z" fill="#F90077"/>
          </svg>
        </div>
